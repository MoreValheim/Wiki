...
|m_variant|0|
|m_durability|100|
|m_name|$item_mushroomblue|
|m_name_EN|Blue mushroom|
|m_description|$item_mushroomblue_description|
|m_description_EN|Glows with a soft blue hue.|
...
|m_food|20|
|m_foodBurnTime|600|
|m_foodColor|rgba(74.61398, 224.7801, 230.625, 255)|
|m_foodRegen|1|
|m_foodStamina|20|
